      ...
      <div class="container px-4 mx-auto">
        <div class="-mx-4 flex flex-wrap justify-between">
          <div class="px-4 my-4 w-full xl:w-1/5">
                ...
                <g fill="none" fill-rule="evenodd">
                  <g transform="translate(0 -75)">
                    ...
                    <text fill="white" font-family="Nunito-Bold, Nunito" font-size="512" font-weight="bold">
                      <tspan x="654" y="518">Fabric Folio</tspan>
                    </text>
                  </g>
                </g>
              </svg>
            ...
            "Discover premium-quality fabrics and stylish clothing at Fabric Folio. We offer a wide range of vibrant textiles and trendy apparel to inspire your creativity and elevate your wardrobe."
            </p>
          </div>
      ...
      <div class="container mx-auto px-4">
        <div class="-mx-4 flex flex-wrap justify-between">
          <div class="px-4 w-full text-center sm:w-auto sm:text-left">
            Copyright © 2024
            - 2025
            Fabric-Folio. All Rights Reserved.
          </div>
          <div class="px-4 w-full text-center sm:w-auto sm:text-left">
